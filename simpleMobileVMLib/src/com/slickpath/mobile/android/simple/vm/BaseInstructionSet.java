...
public class BaseInstructionSet implements Instructions{
    ...
    public static Hashtable<String, Integer> INSTRUCTION_SET_HT = null;
    public static Hashtable<Integer, String> INSTRUCTION_SET_CONV_HT = null;

    public BaseInstructionSet()
    {
        //
        INSTRUCTION_SET_HT = new Hashtable<String, Integer>();
        ...
        INSTRUCTION_SET_CONV_HT = new Hashtable<Integer, String>();

        Set<String> keys = INSTRUCTION_SET_HT.keySet();
